...
\begin{titlepage}
    \begin{center}
        ...
        \vspace{0.5cm}
        {\huge \textbf{Разработка интеллектуального ассистента для~планирования путешествий}}
        
        \vfill
        
        \begin{flushright}
            \begin{minipage}{0.5\textwidth}
                \textbf{Исследователь:} Мицкевич Валерия Олеговна, студент 3 курса 932320 \\
                
                \vspace{0.5cm}
                
                \textbf{Научный руководитель:} доцент кафедры ``Теоретических основ информатики'' Пожидаев Михаил Сергеевич
            \end{minipage}
        \end{flushright}
